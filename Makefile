...
.PHONY: build_ncw
# Applications
.PHONY: build_all_external_apps build_dep_viewer_app build_richdocuments_app build_contacts_app build_notify_push_app build_notify_push_binary build_core_app_theming
...
build_all_external_apps: build_dep_viewer_app build_richdocuments_app build_contacts_app build_notify_push_app build_files_antivirus_app ## Build all external apps
