...
.PHONY: build_ncw
# Applications
.PHONY: build_all_external_apps build_dep_viewer_app build_richdocuments_app build_contacts_app build_calendar_app build_activity_app build_notify_push_app build_notify_push_binary build_fulltextsearch_apps build_core_app_theming build_tasks_app build_ncw_apps_menu_app
...
build_all_external_apps: build_dep_viewer_app build_richdocuments_app build_contacts_app build_calendar_app build_activity_app build_notify_push_app build_files_antivirus_app build_tasks_app build_ncw_apps_menu_app ## Build all external apps
